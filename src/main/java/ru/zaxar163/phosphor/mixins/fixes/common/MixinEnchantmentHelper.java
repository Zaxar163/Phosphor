...
/**
 * Fix a memory leak caused by the world object still being pointed to by the
 * static ENCHANTMENT_ fields. Instead of modifying those static fields, make a
 * new instance of IModifier every use. Overwriting these methods is necessary,
 * it would require a redirect for every single line otherwise.
 * <p>
...
public final class MixinEnchantmentHelper {
	...
	@Shadow
	private static void applyEnchantmentModifierArray(EnchantmentHelper.IModifier modifier,
